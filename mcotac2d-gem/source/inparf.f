...
c*    itest     :  wenn ITest=1 -> Protokoll der Eingabedaten
c*    inma      :  1 = Einsetzen der Partikel �ber inmat[][]
...
c*    npkt      :  Anzahl der St�tzstellen zur Definition der Eintragsfunktion
c*    teil      :  legt Ausschnitt fest mit Anfangs- u. Endknoten
c*    dx[]      :  Zellgr��en in X-Richtung
c*    dy[]      :  Zellgr��en in Y-Richtung
c*    backg     :  "background"-Wert der Schadstoffkonzentration
c*    rd        :  Retardierungsfaktor
c*    lambda    :  Zerfallskonstante
c*    lambt0    :  Verz�gerung bis zum Beginn der Zerfallsprozesse
c*    al        :  longitudinale Dispersivit�t
