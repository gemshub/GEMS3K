...
//				typedef boost::multi_array<double, 2> array_2D_double;
				...
				array_2D_double beta1;			// second virial coefficient contributions
				array_2D_double alpha;			// second virial coefficient contributions
				...
				array_2D_double coord;			// coordinaiton number parameter
				double CN;
