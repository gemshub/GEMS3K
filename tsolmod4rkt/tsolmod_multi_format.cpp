...
bool TSolModMulti::gemipm_from_string( const std::string& data,  DATACH  *dCH, const std::string& test_set_name )
{
    if( data.empty() )
        return false;
...
void  TSolModMulti::read_ipm_format_stream( std::iostream& stream, GEMS3KGenerator::IOModes  type_f, DATACH  *dCH, const std::string& test_set_name )
{
    switch( type_f )
    {
